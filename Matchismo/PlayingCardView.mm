...
static const float kWidthOffset = 0.2;
static const float kHeightOffset = 0.1;
...
- (void)drawRect:(CGRect)rect {
  ...
  if (faceImage) {
    CGRect imageRect = CGRectInset(self.bounds,
                                   self.bounds.size.width * kWidthOffset,
                                   self.bounds.size.height * kHeightOffset);
